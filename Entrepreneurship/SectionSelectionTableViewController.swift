...
class SectionSelectionTableViewController: UITableViewController {
    ...
    var delegates : SectionSelectionTableViewControllerDelegate?
    ...
    override func tableView(_ tableView: UITableView, didDeselectRowAt indexPath: IndexPath) {
        ...
        
        {
            ...
            if let index = selectedIndexPaths.index(of: indexPath.row){
...
//        {
            delegates?.saveIndex(indexes: selectedIndexPaths)
